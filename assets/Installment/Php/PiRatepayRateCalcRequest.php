...
if ($calcValue != '' && $calcMethod != '') {
    ...
    if ($pi_calculator->getPostParameter('cl') == 'order') {
        $bShowPiResultArray = true;
    }
...
if ($pi_calculator->getErrorMsg() != '') {
    ...
    if (!empty($pi_resultArray)) {
        ...
        <div class="rp-table-striped">
            ...
            <div class="rp-menue">
                <div colspan="2" class="small text-end">
